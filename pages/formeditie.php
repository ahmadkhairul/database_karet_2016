...
<form method="post" action="editie">
<table>
<?php
include "connect.php";
$id = $_GET['id'];
$query = "SELECT * FROM `t_ie` WHERE `id` = '$id'";
...
?>
 ...
 <tr>
	<td>Ekspor</td>
	<td>:</td>
	<td><input type="text" class="form-control" name ="ekspor" value="<?php echo $r['ekspor']; ?>"/></td>
 </tr>
  <tr>
	<td>Impor</td>
	<td>:</td>
	<td><input type="text" class="form-control" name ="impor" value="<?php echo $r['impor']; ?>"/></td>
 </tr>
 <tr>
