...
<form method="post" action="simpanie">
<table>
<tr>
...
<option>2030</option>
 ...
 <tr>
	<td>Ekspor</td>
	<td>:</td>
	<td><input class="form-control" type="text" name="ekspor"></td>
 </tr>
 <tr>
	<td>Impor</td>
	<td>:</td>
	<td><input class="form-control" type="text" name="impor"></td>
 </tr>
 <tr>
...
<td style="text-align: center;"><a href="formeditie?id=<?php echo $buff['id'];?>"><span class="glyphicon glyphicon-edit"></span></a> // 
<a href="deleteie?id=<?php echo $buff['id'];?>"><span class="glyphicon glyphicon-remove"></span></a></td>
</tr>
<?php
$no++;
}; 
