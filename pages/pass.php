...
<table>
 <tr>
	...
	<td style="width:1%;">:</td>
	<td style="width:15%;"><input class="form-control" type="text" name="u"></td>
  ...
  <tr>
    ...
    <br />
 <input type="submit" class="btn btn-default" value="Ubah" class="button"> <input class="btn btn-default" type="reset" value="Reset" class="button">
 </form>
   </div>
    <!-- /#wrapper -->
